          ...
          return (
            <SwiperSlide key={album.id} className="mb-12">
              <div className="w-full bg-secondary/80 rounded-[10px] flex flex-col xl:flex-row items-center p-6 xl:p-12 gap-x-12">
                {/* img */}
                <div
                  className="hidden xl:flex w-[500px] h-[500px] xl:w-[500px] xl:h-[500px] relative cursor-pointer rounded-[20px] mix-blend-luminosity
                overflow-hidden"
                >
                  <Image
                    src={album.img}
      ...
      >
        {data?.map((thumb, index) => {
          return (
            <SwiperSlide
              key={index}
              className=" relative group overflow-hidden mix-blend-luminosity border-2 border-transparent w-[254px] rounded-[10px]"
            >
              {/* img */}
              <div
                className="w-[195px] h-[195px] relative sm:w-[360px] sm:h-[360px]
